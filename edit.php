...
$id = $_GET['idPost'];
$data = query("SELECT title, content, create_at FROM posts WHERE id = $id")[0];
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="" method="post">
                    <input type="hidden" name="create" value="<?= $data['create_at'] ?>">
                    <input type="hidden" name="id" value="<?= $id; ?>">
                    <div class="mb-3">
                        <label for="title" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" id="title" placeholder="Insert Title" value="<?= $data['title']; ?>">
                    </div>
                    <div class="mb-3">
